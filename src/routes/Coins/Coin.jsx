            ...
            <div className='content'>
                ...
                <div className='info'>
                    ...
                    <div className='coin-price'>
                        {marketData?.current_price ? <h1>${marketData.current_price.usd}</h1> : null}
                    </div>
                </div>
            </div>
            <div className='content'>
                    ...
                    <tbody>
                        <tr>
                            {['1h', '24h', '7d', '14d', '30d', '1y'].map((period) => (
                                <td key={period}>
                                    {marketData?.[`price_change_percentage_${period}_in_currency`]?.usd ? (
                                        <p>{marketData[`price_change_percentage_${period}_in_currency`].usd.toFixed(2)}%</p>
                                    ) : null}
                                </td>
                            ))}
                        </tr>
            ...
            <div className='content'>
                <div className='stats'>
                    ...
                    <div className='right'>
                        <div className='row'>
                            <h4>Market Cap</h4>
                            {marketData?.market_cap ? <p>${marketData.market_cap.usd}</p> : null}
                        </div>
                        <div className='row'>
